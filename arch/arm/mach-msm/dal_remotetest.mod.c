...
__attribute__((section("__versions"))) = {
	...
	{ 0x79f432ac, "simple_attr_release" },
	{ 0xe5f4a9a, "simple_attr_write" },
	{ 0x6123264b, "simple_attr_read" },
	{ 0xa71d9a7, "generic_file_llseek" },
	{ 0x4610ccb8, "debugfs_remove" },
